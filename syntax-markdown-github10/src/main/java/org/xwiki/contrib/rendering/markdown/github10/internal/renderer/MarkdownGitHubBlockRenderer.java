...
/**
 * Block Renderer for GitHub-Flavored CommonMark syntax. To be used to convert XDOM into GitHub-Flavored Markdown.
 *
 * @version $Id$
 * @since 8.7
 */
...
@Singleton
public class MarkdownGitHubBlockRenderer extends AbstractBlockRenderer
{
    @Inject
    @Named("markdown+github/1.0")
