...
import org.xwiki.contrib.rendering.markdown.commonmark12.internal.renderer.AbstractMarkdownRenderer;

import javax.inject.Inject;
import javax.inject.Named;

/**
 * Generates GitHub-Flavored CommonMark from a {@link org.xwiki.rendering.block.XDOM} object being traversed from the
...
public class MarkdownGitHubRenderer extends AbstractMarkdownRenderer
{
    @Inject
    @Named("markdown+github/1.0")
