...
/**
 * Generate a string representation of a Link reference, in Markdown 1.2.
 *
 * @version $Id$
 * @since 8.6
 */
...
@Singleton
public class Markdown12LinkReferenceSerializer extends XWikiSyntaxLinkReferenceSerializer
{
}
