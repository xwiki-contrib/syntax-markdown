...
/**
 * Block Renderer for GitHub Flavored Markdown syntax. To be used to convert XDOM into GitHub Flavored Markdown.
 *
 * @version $Id$
 * @since 8.7
 */
...
@Singleton
public class MarkdownGithubBlockRenderer extends Markdown12BlockRenderer
{
    @Inject
    @Named("markdown+github/1.0")
