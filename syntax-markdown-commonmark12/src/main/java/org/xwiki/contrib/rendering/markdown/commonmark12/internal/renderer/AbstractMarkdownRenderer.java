 ...
 * @since 8.4
 */
public abstract class AbstractMarkdownRenderer extends AbstractXWikiSyntaxRenderer
{
    /**
    ...
    /**
     * @return the Markdown configuration object to use
     */
    protected abstract MarkdownConfiguration getConfiguration();
}
