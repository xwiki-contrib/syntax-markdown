...
/**
 * Generate a string representation of a Link reference, in Markdown 1.1.
 *
 * @version $Id$
 * @since 8.6
 */
...
@Singleton
public class Markdown11LinkReferenceSerializer extends XWikiSyntaxLinkReferenceSerializer
{
}
